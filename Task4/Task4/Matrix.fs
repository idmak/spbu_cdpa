...
module Matrix = 
    let createRandom<'a when 'a :> ISemiring<'a>> (size: int) (getNextRandom: unit -> 'a) = 
    ...
    let writeToFile<'a when 'a :> ISemiring<'a>> (fullPathToOutputFile: string) (convertToString: 'a -> string) ((Matrix matrix): Matrix<'a>) = 
